...
public class NetHotAdapter extends BaseAdapter {

    private static final String TAG = NetHotBean.class.getSimpleName();
    private final Context context;
    private final List<NetHotBean.ListBean> lists;
    ...
    public NetHotAdapter(Context context, List<NetHotBean.ListBean> lists) {
    ...
    public int getItemViewType(int position) {
        NetHotBean.ListBean listEntity =  lists.get(position);
...
//                System.out.println("mediaItem.getImage().getSmall().get(0)" + mediaItem.getImage().getSmall().get(0));
    ...
    private void bindData(ViewHolder viewHolder, NetHotBean.ListBean mediaItem) {
        ...
        //设置标签
        List<NetHotBean.ListBean.TagsBean> tagsEntities = mediaItem.getTags();
